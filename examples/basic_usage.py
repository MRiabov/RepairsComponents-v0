...
def main():
    ...
    locking_socket = LockingSocket(size=10.0, requires_release=True, name="locking_socket")
    ...
    for i in range(100):
        ...
        if i == 10:
            ...
            if not locking_socket.disconnect():
                print("  Failed to disconnect locking socket (as expected, release not activated)")
