...
gs.init()
europlug = Europlug(0)
obj_path = europlug.save_path_from_name(
    Path("/workspace/data/"), "europlug_0_male", "obj"
)
mjcf_path = europlug.save_path_from_name(
    Path("/workspace/data/"), "europlug_0_male", "xml"
)
